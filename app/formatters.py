...
class JSONFormatter(BaseFormatter):
    def format(self, data: Dict[str, Any], tables: list = None) -> str:
        formatted_data = {
            'invoice_details': {
                'company_registration': self.format_field('org_number', data.get('registration', '')),
...
class XMLFormatter(BaseFormatter):
    def format(self, data: Dict[str, Any], tables: list = None) -> str:
        ...
        ET.SubElement(financial, 'total_amount').text = self.format_field('currency', data.get('total', ''))
        ...
        ET.SubElement(payment, 'reference').text = self.format_field('kid', data.get('reference', ''))
